...
import { formatDisplayUrl, isTonSiteUrl, normalizeUrl } from '@/lib/url'
            ...
            {isTonSite && !isFocused && (
              <div
                className={cn(
                  ...
                  isAnonymous ? 'bg-[#229ED9] text-white' : 'bg-primary text-primary-foreground',
                )}
              >
                tonsite://
              </div>
            ...
            {inputValue && !isFocused && (
              ...
              >
                <Star
                  className={cn(
                    'h-4 w-4',
                    urlIsBookmarked ? 'fill-yellow-400 text-yellow-400' : 'text-muted-foreground',
                  )}
                />
              </button>
            )}
