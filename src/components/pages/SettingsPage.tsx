...
import { BookmarksManagerSheet } from '@/components/settings/BookmarksManagerSheet'
import { ProxyLogsSheet } from '@/components/settings/ProxyLogsSheet'
...
import { APP_NAME, APP_VERSION, DEFAULT_PROXY_PORT, INTERNAL_ROUTES } from '@/shared/constants'
  ...
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 28 28" fill="none">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.64 24.9228C9.50685 24.6945 6.7511 22.874 5.36441 19.0546C4.51333 16.7104 5.15302 13.517 7.28352 9.47427C7.47475 9.11126 8.58995 9.53182 8.65381 9.63267L10.324 12.2883C10.4392 12.47 10.9441 12.3112 10.9736 12.2514C11.4554 11.2759 11.856 10.0183 12.1755 8.47867C12.4843 6.9906 12.6347 5.61613 12.64 4.00916C12.6414 3.59465 13.399 2.94855 13.5 3.00326C15.9366 4.32248 17.9506 5.95774 19.1561 7.57153C21.2201 10.3345 21.7615 12.4706 21.9187 15.0658C22.2754 17.8461 21.4583 20.2723 19.4675 22.3444C17.4767 24.4166 15.2009 25.276 12.64 24.9228Z"
        fill="currentColor"
      />
    </svg>
  )
...
function HomeIcon({ className }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 22 19" fill="none">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.9996 2.58541L18.4349 9.88078V18.0881C18.4349 18.5903 18.0174 19 17.5055 19H14.2525C13.9948 19 13.7878 18.797 13.7878 18.544V13.0725C13.7878 12.8196 13.5809 12.6165 13.3231 12.6165H8.67611C8.41834 12.6165 8.21141 12.8196 8.21141 13.0725V18.544C8.21141 18.797 8.00447 19 7.7467 19H4.49378C3.98189 19 3.56438 18.5903 3.56438 18.0881V9.88078L10.9996 2.58541ZM11.468 0.155991L11.5478 0.223672L16.5761 5.15375V2.12945C16.5761 1.87653 16.783 1.67349 17.0408 1.67349H17.9702C18.2279 1.67349 18.4349 1.87653 18.4349 2.12945V6.97759L21.7713 10.2548C22.0762 10.5505 22.0762 11.0349 21.7713 11.3306C21.4954 11.6049 21.0597 11.6263 20.7547 11.3983L20.6749 11.3306L10.9996 1.83735L1.32437 11.3306C1.04845 11.6049 0.612792 11.6263 0.307831 11.3983L0.22796 11.3306C-0.0515871 11.0599 -0.0733696 10.6324 0.158982 10.3332L0.22796 10.2548L10.4514 0.223672C10.7273 -0.050617 11.163 -0.0719892 11.468 0.155991Z"
        fill="currentColor"
      />
    </svg>
  )
...
function TonIcon({ className }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 22 23" fill="none">
      <path
        d="M18.4283 0H3.57085C0.839071 0 -0.892366 3.08068 0.481939 5.57102L9.65145 22.1863C10.2498 23.2712 11.7494 23.2712 12.3477 22.1863L21.5191 5.57102C22.8915 3.08459 21.1601 0 18.4302 0H18.4283ZM9.64397 17.2037L7.64702 13.1632L2.82854 4.15383C2.51067 3.57718 2.90333 2.83829 3.56898 2.83829H9.6421V17.2057L9.64397 17.2037ZM19.1669 4.15188L14.3503 13.1652L12.3533 17.2037V2.83633H18.4264C19.0921 2.83633 19.4847 3.57523 19.1669 4.15188Z"
        fill="currentColor"
      />
    </svg>
  )
...
function CodeIcon({ className }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 22 14" fill="none">
      <path
        d="M6.59065 3.33778C7.13645 2.80214 7.13645 1.93737 6.59065 1.40173C6.04486 0.86609 5.16369 0.86609 4.6179 1.40173L6.59065 3.33778ZM1.39573 6.5L0.409346 5.53197C-0.136449 6.06761 -0.136449 6.93238 0.409346 7.46803L1.39573 6.5ZM4.6179 11.5983C5.16369 12.1339 6.04486 12.1339 6.59065 11.5983C7.13645 11.0626 7.13645 10.1979 6.59065 9.66222L4.6179 11.5983ZM4.6179 1.40173L0.409346 5.53197L2.38211 7.46803L6.59065 3.33778L4.6179 1.40173ZM0.409346 7.46803L4.6179 11.5983L6.59065 9.66222L2.38211 5.53197L0.409346 7.46803Z"
        fill="currentColor"
      />
      <path
        d="M16.3509 9.66222C15.883 10.1979 15.883 11.0626 16.3509 11.5983C16.8187 12.1339 17.574 12.1339 18.0418 11.5983L16.3509 9.66222ZM20.8037 6.5L21.6491 7.46803C22.117 6.93238 22.117 6.06761 21.6491 5.53197L20.8037 6.5ZM18.0418 1.40173C17.574 0.86609 16.8187 0.86609 16.3509 1.40173C15.883 1.93737 15.883 2.80214 16.3509 3.33778L18.0418 1.40173ZM18.0418 11.5983L21.6491 7.46803L19.9582 5.53197L16.3509 9.66222L18.0418 11.5983ZM21.6491 5.53197L18.0418 1.40173L16.3509 3.33778L19.9582 7.46803L21.6491 5.53197Z"
        fill="currentColor"
      />
      <path
        d="M13.958 1.49763C14.1437 0.852295 13.6955 0.195636 12.972 0.0371299C12.2421 -0.127035 11.4994 0.269227 11.3201 0.908904L13.958 1.49763ZM8.042 12.5024C7.85632 13.1477 8.3045 13.8044 9.028 13.9629C9.75789 14.127 10.5006 13.7308 10.6799 13.0911L8.042 12.5024ZM11.3201 0.908904L8.042 12.5024L10.6799 13.0911L13.958 1.49763L11.3201 0.908904Z"
        fill="currentColor"
      />
    </svg>
  )
...
export function SettingsPage() {
  ...
  const fetchLogs = async () => {
    setLoadingLogs(true)
    try {
      setLogs(await platform.proxy.getLogs())
    } catch (error) {
      logger.error('Failed to fetch proxy logs', error)
    } finally {
  ...
  useEffect(() => {
    if (!cleared) return
    const timer = window.setTimeout(() => setCleared(false), 2_000)
  ...
  const handleAnonymousModeChange = async (checked: boolean) => {
    if (!isConnected) {
      setPreference('anonymousMode', checked)
      return
    }

    const previousMode = preferences.anonymousMode
    ...
    try {
      ...
      if (proxyState.status !== 'connected' || proxyState.isAnonymous !== checked) {
        throw new Error('The proxy did not apply the requested privacy mode')
      }
    } catch (error) {
      setPreference('anonymousMode', previousMode)
      logger.error('Failed to reconnect the proxy', error)
    } finally {
  ...
  const openEditor = (field: EditingField) => {
    if (field === 'proxyPort') {
      setEditValue(String(preferences.proxyPort))
    } else if (field === 'homepage') {
      setEditValue(preferences.homepage === INTERNAL_ROUTES.start ? '' : preferences.homepage)
    }
  ...
  const saveEditor = () => {
    if (editingField === 'proxyPort') {
      const port = Number.parseInt(editValue, 10)
      setPreference(
        'proxyPort',
        Number.isInteger(port) && port > 1024 && port <= 65_535 ? port : DEFAULT_PROXY_PORT,
      )
    } else if (editingField === 'homepage') {
      setPreference('homepage', normalizeUrl(editValue) || INTERNAL_ROUTES.start)
    }
      ...
      <div className="px-3 pt-3 pb-24 space-y-4">
          ...
          <SettingsItem
            ...
            right={
              <Toggle
                ...
                onChange={(checked) => setPreference('autoConnect', checked)}
                ariaLabel={t('auto_connect')}
              />
            }
          />
          <SettingsItem
            ...
            right={
              <div className="flex items-center gap-1">
                <span className="text-[13px] text-muted-foreground">{preferences.proxyPort}</span>
            ...
            right={
              <div className="flex items-center gap-1">
                <span className="text-[13px] text-muted-foreground truncate max-w-[120px]">
                  {preferences.homepage === INTERNAL_ROUTES.start
                    ? t('start_page')
          ...
          <SettingsItem
            ...
            right={
              <Toggle
                ...
                onChange={(checked) => setPreference('javaScriptEnabled', checked)}
                ariaLabel={t('javascript')}
              />
            }
          />
          <SettingsItem
            ...
            right={
              <Toggle
                ...
                onChange={(checked) => setPreference('thirdPartyCookies', checked)}
                ariaLabel={t('third_party_cookies')}
              />
            }
          />
          <SettingsItem
            ...
            right={
              <Toggle
                checked={preferences.clearOnExit}
                onChange={(checked) => setPreference('clearOnExit', checked)}
                ariaLabel={t('clear_on_exit')}
              />
            }
          />
          <SettingsItem
        ...
        <SectionGroup label={t('about')}>
          <SettingsItem
            ...
            right={<span className="text-[13px] text-muted-foreground">{APP_VERSION}</span>}
          />
        </SectionGroup>
      </div>
        ...
        {editingField !== null && (
          <div className="space-y-4">
            <p className="text-[13px] text-muted-foreground">
              {editingField === 'proxyPort' ? t('proxy_port_edit_desc') : t('homepage_edit_desc')}
            </p>
            <EditInput
              ...
              placeholder={
                editingField === 'proxyPort' ? String(DEFAULT_PROXY_PORT) : INTERNAL_ROUTES.start
              }
              autoFocus
            />
            <div className="flex gap-3">
              <Button variant="ghost" className="flex-1" onClick={() => setEditingField(null)}>
                {tc('cancel')}
              </Button>
        ...
        <div className="space-y-1">
          {SUPPORTED_LANGUAGES.map((lang) => (
            <button
              ...
              key={lang.code}
              onClick={() => {
                setPreference('language', lang.code)
...
function SectionGroup({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div>
      <p className="text-[15px] font-semibold text-primary px-2 mb-1">{label}</p>
...
function SettingsItem({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn('w-7 h-7 rounded-[9px] flex items-center justify-center shrink-0', iconBg)}
      >
        <Icon className="h-5 w-5 text-primary-foreground" />
      </div>
      {/* Content + divider — padding here so border sits perfectly centered */}
      <div className={cn('flex-1 min-w-0 flex items-center justify-between py-2.5')}>
